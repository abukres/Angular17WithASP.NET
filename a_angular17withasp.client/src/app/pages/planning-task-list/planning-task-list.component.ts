...
import { taskPanelItems } from '../../types/resource';
import { Task, newTask } from '../../types/task';
import { DataService, ScreenService } from '../../services';
import { forkJoin, map, Observable } from 'rxjs';
import { TaskFormComponent, TaskFormModule } from '../../components/library/task-form/task-form.component';
import { FormPopupModule } from '../../components';
import { TaskListGridComponent, TaskListModule } from '../../components/library/task-list-grid/task-list-grid.component';
import { TaskListKanbanModule, TaskListKanbanComponent } from '../../components/library/task-list-kanban/task-list-kanban.component';
import { TaskListGanttComponent, TaskListGanttModule } from '../../components/library/task-list-gantt/task-list-gantt.component';
